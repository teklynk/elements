...
var refreshRate = 0;
    var chatTimer;
var chatCount = 0;
    chatLimit = chatLimit + 1; //auto scroll to bottom of chat-container every 1 second
...
function handleChat(channel, user, message, self) {
    ...
    chatLine.dataset.channel = channel; //only show messages that have the message-type=chat
